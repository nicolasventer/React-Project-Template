 ...
 * @param prefix optional label to prepend to the log output
 * @returns the given value
 */
export const logRet = <T>(value: T, prefix?: string) => {
...
/**
 * Executes a function and returns its result, or a fallback if it throws.
 * @param fn Function to execute
 * @param fallback Fallback function executed on error
 * @returns The function result or fallback result
 */
